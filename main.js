...
function resetAllData() {
    ...
    // Reset UI and add empty course
    updateSemesterView();
    addInitialCourse();
    
    // Reset all displays
    document.getElementById('sgpaResult').textContent = '-';
    document.getElementById('sgpaPercentage').textContent = '(-)';
    document.getElementById('cgpaResult').textContent = '-';
    document.getElementById('cgpaPercentage').textContent = '(-)';
    document.getElementById('semesterCount').textContent = '1';
}
...
function calculateAndUpdateResults() {
    ...
    updateResults(
        sgpa,
        formatPercentage(toPercentage(sgpa)),
        cgpa,
        formatPercentage(toPercentage(cgpa))
    );
    
    document.getElementById('semesterCount').textContent = semesters.length;
}

function updateResults(sgpa, sgpaPercentage, cgpa, cgpaPercentage) {
    document.getElementById('sgpaResult').textContent = sgpa;
    document.getElementById('sgpaPercentage').textContent = sgpaPercentage;
    document.getElementById('cgpaResult').textContent = cgpa;
    document.getElementById('cgpaPercentage').textContent = cgpaPercentage;
}
